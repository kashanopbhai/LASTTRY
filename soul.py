...
bot = telebot.TeleBot('7639073042:AAGmemw6qkWfQU3LF_YuG3FRaOtscSbY650')
...
def handle_soul(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = " ミ🥹★ 𝘈𝘤𝘤𝘦𝘴𝘴 𝘭𝘦 𝘭𝘦 𝘣𝘳𝘰 ★🥹彡DM - @NARUTO_OWNERS ."
...
def welcome_start(message):
    ...
    response = f'''ıllıllı⭐🌟 W͙e͙l͙c͙o͙m͙e͙ t͙o͙ NARUTO Family ❣️ 🌟⭐ıllıllı \n {user_name}! \n🄱🄶🄼🄸 🄺🄸 🄶🄰🄽🄳 🄼🄰🅁🄽🄴 🄰🄰 🄶🅈🄴😜
